...
<div class="page-title">
	<img src="<?php echo e(asset('images/title/title.png')); ?>" alt="Programs">
	<h1 id="title" class="title">Programs</h1>
</div>
<div class="program">
...
<?php echo $__env->make('/web/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/laravel6/resources/views/web/content/program.blade.php ENDPATH**/ ?>